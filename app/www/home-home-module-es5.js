...
var HomePage = /** @class */ (function () {
    function HomePage(router, loadingController) {
        ...
        this.infos = [];
        this.projId = 'lista-do-joao';
        this.ref = firebase__WEBPACK_IMPORTED_MODULE_4__["database"]().ref().child('orders');
        this.ref.on('value', function (resp) {
            _this.infos = [];
            _this.infos = snapshotToArray(resp);
    ...
    HomePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"]])
    ], HomePage);
    return HomePage;
}());
